...
def main():
    ...
    ap.add_argument("--out_dir", type=str, default="Outputs/Sesion02/knn_binary_sesion02_top30")
    ...
    for pid, path in sorted(files.items()):
        ...
        joblib.dump(knn_clean, os.path.join(args.out_dir, f"knn_clean_for_shap_sesion02_participant_{pid}.pkl"))
        joblib.dump(scaler_clean, os.path.join(args.out_dir, f"scaler_knn_for_shap_sesion02_participant_{pid}.pkl"))
