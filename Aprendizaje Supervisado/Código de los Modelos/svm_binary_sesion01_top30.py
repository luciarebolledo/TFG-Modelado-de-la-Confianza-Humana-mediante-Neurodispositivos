...
# === Split persistence ===
# EXPL: Mira si ya hay un split guardado y si lo hay lo coge y sin crea uno nuevo
...
# === IO & features ===
# Cargar los datos y ver que no falta nada
...
# === Modelo (SVM + scaler) ===
# Creamos el modelos SVM y lo esacalamos (resta media y divide por desviacion)
def build_pipeline():
...
def main():
    ...
    ap.add_argument("--out_dir", type=str, default="Outputs/Sesion01/svm_binary_sesion01_top30")
    ...
    # Grid SVM
    # Valores del grid Search par SVM
    param_grid = {
